        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Please log in to access our chips & snacks section.
            </p>
            <button
              onClick={() => setShowAuthModal("login")}
              className="px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-700 text-white rounded-lg hover:from-orange-600 hover:to-orange-800 transition-all duration-300">
              Sign In
            </button>
          </div>
        </div>
    ...
    <div className="p-4 sm:p-6 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="p-3 bg-gradient-to-r from-orange-500 to-orange-700 rounded-lg">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Crunchy Goodness - {pagination?.total || 0} Products Available
            </p>
          </div>
        </div>
          ...
          <>
            {products.length === 0 ? (
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  {searchQuery
                    ? `No chips & snacks found matching "${searchQuery}"`
                    : "No chips & snacks available at the moment."}
                </p>
              </div>
            ) : (
