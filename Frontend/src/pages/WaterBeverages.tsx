        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Please log in to access our water & beverages section.
            </p>
            <button
              onClick={() => setShowAuthModal("login")}
              className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-lg hover:from-blue-600 hover:to-blue-800 transition-all duration-300">
              Sign In
            </button>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Fresh & Pure - {pagination?.total || 0} Products Available
            </p>
          </div>
        </div>
          ...
          <>
            {products.length === 0 ? (
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  {searchQuery
                    ? `No water & beverage products found matching "${searchQuery}"`
                    : "No water & beverage products available at the moment."}
                </p>
              </div>
            ) : (
